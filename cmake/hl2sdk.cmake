...
add_library(hl2sdk::steam SHARED IMPORTED)
...
target_include_directories(hl2sdk::steam INTERFACE ${hl2sdk_INCLUDE_DIRS})
...
if(CMAKE_SIZEOF_VOID_P EQUAL 8)
    ...
    target_compile_definitions(hl2sdk::steam INTERFACE PLATFORM_64BITS)
endif()
...
if(LINUX)
    ...
    set_target_properties(hl2sdk::steam PROPERTIES IMPORTED_LOCATION ${hl2sdk_SOURCE_DIR}/lib/linux64/libsteam_api.so)
...
elseif(WIN32)
    ...
    set_target_properties(hl2sdk::steam PROPERTIES IMPORTED_IMPLIB ${hl2sdk_SOURCE_DIR}/lib/public/win64/steam_api64.lib)
    set_target_properties(hl2sdk::steam PROPERTIES IMPORTED_LOCATION ${hl2sdk_SOURCE_DIR}/lib/public/win64/steam_api64.lib)
...
if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    ...
    target_compile_definitions(hl2sdk::steam INTERFACE COMPILER_GCC GNUC)
...
#    message(WARNING "cs2metamod configuration is incomplete for this compiler!")
    ...
    target_compile_definitions(hl2sdk::steam INTERFACE COMPILER_MSVC)
    ...
    if(CMAKE_SIZEOF_VOID_P EQUAL 8)
        ...
        target_compile_definitions(hl2sdk::steam INTERFACE COMPILER_MSVC64 _AMD64_)
        ...
        target_compile_definitions(hl2sdk::steam INTERFACE COMPILER_MSVC32 _X86_)
